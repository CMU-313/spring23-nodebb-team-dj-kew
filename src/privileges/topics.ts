...
export async function filterTids (privilege: string, tids: Array<number | string>, uid: (number | string)) {
...
export async function filterUids (privilege: string, tid: (number | string), uids: Array<number | string>) {
