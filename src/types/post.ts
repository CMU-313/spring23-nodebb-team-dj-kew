...
export interface PostObjectPartial {
  pid?: number
  tid?: number | string
  content?: string
  uid?: number | string
...
export interface PostsMethods {
  getPostsFields: (pids: number[], fields: Array<keyof PostObject>) => Promise<OptionalPostList>
  ...
  getPostFields: (pid: number, fields: Array<keyof PostObject>) => Promise<OptionalPost>
