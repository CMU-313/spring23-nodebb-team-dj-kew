...
module.exports = function (Topics) {
  ...
  Topics.create = async function (data) {
    ...
    const result = await plugins_1.default.hooks.fire('filter:topic.create', { topic: topicData, data })
    ...
    plugins_1.default.hooks.fire('action:topic.save', { topic: lodash_1.default.clone(topicData), data })
  ...
  Topics.post = async function (data) {
    ...
    plugins_1.default.hooks.fire('action:topic.post', { topic: topicData, post: postData, data })
  ...
  Topics.reply = async function (data) {
    ...
    plugins_1.default.hooks.fire('action:topic.reply', { post: lodash_1.default.clone(postData), data })
    return postData
  }
