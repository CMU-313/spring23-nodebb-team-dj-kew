...
import { PostObject, OptionalPost, OptionalPostList, PostsMethods, PostsWrapper } from '../types'
...
function modifyPost (post: OptionalPost, fields: Array<keyof PostObject>) {
  if (post) {
